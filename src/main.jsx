...
function NewCaseModal({clientOptions=[],vessels=[],team=[],close,submit}){
  ...
  const [form,setForm]=useState({buque:'',imo:'',mmsi:'',cliente:clientOptions[0]||'UME Shipping',puerto:'Barcelona',etaDate:'',etaTime:'',etbDate:'',etbTime:'',prioridad:'Media',bultos:'',createReception:false,receptionDate:'',receptionStart:'09:00',receptionEnd:'10:00',receptionLocation:warehouse,createTransport:false,transportDate:'',transportStart:'',transportEnd:'',transportDateManual:false,transportStartManual:false,transportPickup:warehouse,transportDelivery:'BUQUE POR CONFIRMAR  -  Barcelona',transportConductor:'Sin asignar'});
  const update=event=>{
