  ...
  return <div className="shell">
    ...
    <main className="main">
      ...
      <div className="content">
        ...
        {tab==='facturacion'&&showFinance&&<Facturacion openCase={openCase} notify={notify} invoices={finance.invoices} cases={casesWithFinance} warehouseEntries={warehouseEntries} transports={transports} calendarEvents={calendarEvents} clients={finance.clients} updateInvoice={updateInvoice} csrfToken={auth.csrfToken}/>}
...
function Facturacion({openCase,notify,invoices,cases,warehouseEntries=[],transports=[],calendarEvents=[],clients=[],updateInvoice,csrfToken}){
  const [editing,setEditing]=useState(null);
