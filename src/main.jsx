...
function DraggableCalendarEvent({event,cases,team,saveEvent,setEditing,canDeleteEvent,deleteEvent,startPointerDrag,draggingId,suppressClick}){
  const clean=withoutCalendarLayout(event);
