...
function Expedientes({cases,selected,select,search,setSearch,completeCaseStep,notify,showFinance,updateCase,clientOptions,warehouseEntries,transports,csrfToken,reloadOperational}){
